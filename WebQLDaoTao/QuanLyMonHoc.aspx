<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuanLyMonHoc.aspx.cs" Inherits="WebQLDaoTao.QuanLyMonHoc" %>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="btnClose" runat="server" class="btn btn-secondary" OnClientClick="hideModal();" Text="Đóng" />
    ...
    <div>
        ...
        <asp:GridView DataKeyNames="MaMH" ID="gvMonHoc" runat="server" AutoGenerateColumns="False" OnRowEditing="gvMonHoc_RowEditing"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Tiện ích">
                    <ItemTemplate>
